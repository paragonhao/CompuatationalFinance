...
plot(y=callPrice,x=volatilityCP, xlab="Volatility",
...
plot(x= year, y= fixedLambdaTwo[fixedLambdaTwo$lamdaOne==0.05,]$Option_Price, type = "l",ylim = c(200,7000), ylab = "Default Option Price", main = "LamdaTwo = 0.4, Option Price")
...
plot(x= year, y= fixedLambdaTwo[fixedLambdaTwo$lamdaOne==0.05,]$Probability, type = "l",ylim = c(0,1), ylab = "Default Probability", main = "LamdaTwo = 0.4, Option Price")
